class SearchModel {
  List<Legs>? departureLegs;
  List<Legs>? returnLegs;

  SearchModel({this.departureLegs, this.returnLegs});

  SearchModel.fromJson(Map<String, dynamic> json) {
    if (json['departureLegs'] != null) {
      departureLegs = <Legs>[];
      json['departureLegs'].forEach((v) {
        departureLegs!.add(new Legs.fromJson(v));
      });
    }
    if (json['returnLegs'] != null) {
      returnLegs = <Legs>[];
      json['returnLegs'].forEach((v) {
        returnLegs!.add(new Legs.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.departureLegs != null) {
      data['departureLegs'] =
          this.departureLegs!.map((v) => v.toJson()).toList();
    }
    if (this.returnLegs != null) {
      data['returnLegs'] = this.returnLegs!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
